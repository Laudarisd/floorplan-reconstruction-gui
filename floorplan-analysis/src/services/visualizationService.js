...
export const drawAnnotations = (
  ...
  const LABEL_HEIGHT = 20 * z;  // Reduced from 28 to 20
  const LABEL_PADDING = 6 * z;  // Reduced from 8 to 6
  const FONT_SIZE = 12 * z;     // Reduced from 18 to 12
